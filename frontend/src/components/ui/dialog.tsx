...
// shadcn/ui-Dialog auf Basis des Radix-Dialogs – der Baustein, den das
// Design-Konzept für das Buchungsformular, „Raum anlegen/bearbeiten" und
// Bestätigungsfragen vorsieht (zentriert, Overlay, Fokus-Falle). Gleiche
// Token wie überall: bg-card/border statt roher Hex-Werte.
