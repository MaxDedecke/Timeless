# Automatische Prüfung: Raumkalender: Buchungen pro Raum unter /rooms/:id anzeigen
...
Ausgabe:
```
… (5111 Zeichen gekürzt)
 001 bis 003
  ---
  duration_ms: 30.015475
  type: 'test'
  ...
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.9 [39m[90m/workspaces/frontend[39m
 ...
 [32m✓[39m test/RoomList.test.tsx [2m([22m[2m19 tests[22m[2m)[22m[33m 914[2mms[22m[39m
 [32m✓[39m test/DayView.test.tsx [2m([22m[2m17 tests[22m[2m)[22m[33m 678[2mms[22m[39m
 [32m✓[39m test/RoomCalendar.test.tsx [2m([22m[2m11 tests[22m[2m)[22m[33m 698[2mms[22m[39m
 [32m✓[39m test/RoomForm.test.tsx [2m([22m[2m4 tests[22m[2m)[22m[33m 735[2mms[22m[39m
   [33m[2m✓[22m[39m RoomForm – Submit-Fehleranzeige (Reject-Case)[2m > [22mzeigt einen Backend-400 als destructives Alert über dem Formular und aktiviert den Button danach wieder [33m327[2mms[22m[39m
 [32m✓[39m test/TimeGrid.test.tsx [2m([22m[2m12 tests[22m[2m)[22m[90m 157[2mms[22m[39m
 [32m✓[39m test/App.test.tsx [2m([22m[2m4 tests[22m[2m)[22m[90m 272[2mms[22m[39m
 ...
 [32m✓[39m test/proxy.test.ts [2m([22m[2m2 tests[22m[2m)[22m[90m 259[2mms[22m[39m

[2m Test Files [22m [1m[32m12 passed[39m[22m[90m (12)[39m
[2m      Tests [22m [1m[32m99 passed[39m[22m[90m (99)[39m
[2m   Start at [22m 17:00:55
[2m   Duration [22m 11.68s[2m (transform 371ms, setup 0ms, collect 2.46s, tests 3.80s, environment 2.88s, prepare 880ms)[22m
...
[2mdist/[22m[2massets/[22m[36mindex-BeBSuxPn.js   [39m[1m[2m263.15 kB[22m[1m[22m[2m │ gzip: 81.09 kB[22m
