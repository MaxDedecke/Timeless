# Automatische Prüfung: Backend: Genehmigungspflicht-Flag je Raum (Migration + Raum-API)
...
```
… (418 Zeichen gekürzt)
st.tsx [2m([22m[2m19 tests[22m[2m)[22m[33m 850[2mms[22m[39m
 [32m✓[39m test/TimeGrid.test.tsx [2m([22m[2m24 tests[22m[2m)[22m[90m 211[2mms[22m[39m
 [32m✓[39m test/BookingForm.test.tsx [2m([22m[2m5 tests[22m[2m)[22m[33m 837[2mms[22m[39m
   [33m[2m✓[22m[39m BookingForm – Erfolgsfall[2m > [22msendet Raum, Datum, Start/Ende als UTC-ISO und Urheber an POST /api/bookings, schließt den Dialog und zeigt die neue Buchung im Kalender [33m337[2mms[22m[39m
 [32m✓[39m test/RoomSearch.test.tsx [2m([22m[2m3 tests[22m[2m)[22m[33m 820[2mms[22m[39m
   [33m[2m✓[22m[39m Freie-Räume-Suche – Buchungseinstieg aus dem Treffer[2m > [22möffnet den Dialog mit Treffer-Raum und filterübernommenem Zeitraum, sendet genau diesen an POST /api/bookings und nimmt den Raum aus der aktualisierten Trefferliste [33m388[2mms[22m[39m
 [32m✓[39m test/RoomForm.test.tsx [2m([22m[2m4 tests[22m[2m)[22m[33m 763[2mms[22m[39m
 [32m✓[39m test/App.test.tsx [2m([22m[2m6 tests[22m[2m)[22m[33m 428[2mms[22m[39m
 [32m✓[39m test/BookingStatusBadge.test.tsx [2m([22m[2m8 tests[22m[2m)[22m[90m 63[2mms[22m[39m
 ...
 [32m✓[39m test/proxy.test.ts [2m([22m[2m2 tests[22m[2m)[22m[90m 249[2mms[22m[39m
...
[2m   Duration [22m 16.56s[2m (transform 480ms, setup 1.12s, collect 2.82s, tests 6.14s, environment 3.60s, prepare 948ms)[22m
...
[2mdist/[22m[2massets/[22m[35mindex-NEfqlC-g.css  [39m[1m[2m 21.09 kB[22m[1m[22m[2m │ gzip:   4.97 kB[22m
[2mdist/[22m[2massets/[22m[36mindex-Pb_WzSi3.js   [39m[1m[2m356.36 kB[22m[1m[22m[2m │ gzip: 106.02 kB[22m
