...
test("InMemoryDb: Transaktionen über connect() – COMMIT sichtbar, ROLLBACK wirft nichts weg", async () => {
  ...
  assert.equal(rolledBack.rowCount, 0, "Nach ROLLBACK darf die Zeile nicht existieren");
});
